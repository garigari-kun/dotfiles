...
class CommandEditorScroll extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const linesBelowCursor = vimState.cursors[0].stop.line - visibleRange.start.line - timesToRepeat;
 ...
 */
class CommandScrollAndMoveCursor extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.ModeName.Normal, mode_1.ModeName.Visual, mode_1.ModeName.VisualLine, mode_1.ModeName.VisualBlock];
        this.runsOnceForEachCountPrefix = false;
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let scrollLinesClamped;
            if (this.to === 'down') {
                scrollLinesClamped = Math.min(scrollLines, vimState.editor.visibleRanges[0].start.line);
            }
            else {
                scrollLinesClamped = Math.min(scrollLines, vimState.editor.document.lineCount - 1 - vimState.editor.visibleRanges[0].end.line);
            }
            ...
            if (smoothScrolling) {
                vimState.cursorStopPosition = position_1.Position.FromVSCodePosition(vimState.editor.selection.active).obeyStartOfLine();
            }
            else {
                ...
                vimState.cursorStopPosition = new position_1.Position(newPositionLine, 0).obeyStartOfLine();
            }
            return vimState;
        });
    }
...
let CommandMoveHalfPageDown = class CommandMoveHalfPageDown extends CommandScrollAndMoveCursor {
    ...
    getNumLines(vimState) {
        return configuration_1.configuration.getScrollLines(vimState.editor.visibleRanges);
    }
};
